...
$(function(){
	...
	$("li.answeritem").click(function(){
		...
		$.ajax({
			...
			success:function(segmentdata){
				...
				if(myChart == undefined){
					myChart = echarts.init(document.getElementById('scorebarchart'));
					        ...
					        var option = {
					            ...
					            xAxis: {
					                data: segmentdata.level
					            },
					            yAxis: {},
					            series: [{
					                name: '销量',
					                type: 'bar',
					                data: segmentdata.count
					            }]
					        };
		...
		$.ajax({
			type:"get",
			url:"getgoalradardata",
			async:true,
			data:{"classId":classId,"answerId":answerId},
			dataType:"json",
			success:function(goalradardata){
				// console.log(typeof(paperscanFull))
				console.log(goalradardata)
				// if(myChart == undefined){
				// 	myChart = echarts.init(document.getElementById('scorebarchart'));
